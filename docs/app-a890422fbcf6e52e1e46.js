    ...
    [4],
    {
        "+ZDr": function (t, e, n) {
            ...
            (e.withAssetPrefix = function (t) {
                return d(t, "/react-accordion-comp");
            }),
            ...
            function d(t, e) {
                let n, r;
                if ((void 0 === e && (e = "/react-accordion-comp"), !v(t))) return t;
                if (t.startsWith("./") || t.startsWith("../")) return t;
                const o =
                    null !== (n = null !== (r = e) && void 0 !== r ? r : "/react-accordion-comp") &&
                    void 0 !== n
                        ? n
                        : "/";
                return (
            ...
            t.exports = function (t) {
                ...
                for (const a in t)
                    if (Object.prototype.hasOwnProperty.call(t, a)) {
                        const c = i ? Object.getOwnPropertyDescriptor(t, a) : null;
        ...
        "5s+n": function (t, e, n) {
            ...
            var r,
                ...
                et = function (t, e) {
                    O.call(s, function () {
                        V ? K.emit("rejectionHandled", t) : X("rejectionhandled", t, e.value);
                    });
                },
                nt = function (t, e, n, r) {
                    return function (o) {
                ...
                u ||
                    ...
                    "function" == typeof Y &&
                        c(
                            ...
                            {
                                fetch: function (t) {
                                    return P(N, Y.apply(s, arguments));
                                },
                            },
                        ))),
            c({ global: !0, wrap: !0, forced: J }, { Promise: N }),
            d(N, I, !1, !0),
            v(I),
            (i = l(I)),
            c(
            ...
            c(
                { target: I, stat: !0, forced: u || J },
                {
                    resolve: function (t) {
                        return P(u && this === i ? N : this, t);
                    },
                },
            ),
            c(
        ...
        "6JNq": function (t, e, n) {
            const r = n("UTVS"),
                ...
                a = n("m/L8");
            t.exports = function (t, e) {
                for (let n = o(e), c = a.f, u = i.f, s = 0; s < n.length; s++) {
                    const l = n[s];
                    r(t, l) || c(t, l, u(e, l));
                }
            };
        ...
        ImZN: function (t, e, n) {
            ...
            (t.exports = function (t, e, n, l, f) {
                ...
                for (m = p.next; !(y = m.call(p)).done; )
                    if ("object" == typeof (g = u(p, b, y.value, l)) && g && g instanceof s)
                        return g;
                return new s(!1);
            }).stop = function (t) {
                return new s(!0, t);
            ...
            "https:" !== window.location.protocol && "localhost" !== window.location.hostname
                ...
                : "serviceWorker" in navigator &&
                  navigator.serviceWorker
                      .register("/react-accordion-comp/sw.js")
                      .then(function (t) {
                ...
                return [
                    ...
                    function (t) {
                        ...
                        for (var f, p = [], h = 0; null !== (f = u(a, s)); ) {
                            const d = String(f[0]);
                            (p[h] = d), "" === d && (a.lastIndex = c(s, i(a.lastIndex), l)), h++;
                        }
                        return 0 === h ? null : p;
                    },
                ];
            ...
            t.exports = function (t) {
                ...
                if (
                    ...
                    for (n = new v((e = c(d.length))); e > w; w++)
                        (h = y ? m(d[w], w) : d[w]), u(n, w, h);
                else
                    for (p = (f = b.call(d)).next, n = new v(); !(l = p.call(f)).done; w++)
                        (h = y ? i(f, m, [l.value, w], !0) : l.value), u(n, w, h);
                return (n.length = w), n;
            };
        },
        TqRt: function (t, e) {
        ...
        UxWs: function (t, e, n) {
            ...
            Object(r.apiRunnerAsync)("onClientEntry").then(function () {
                ...
                const t = function (t) {
                    ...
                    l = o.location;
                a &&
                        "/react-accordion-comp" + a !== l.pathname &&
                        !(
                            D.findMatchPath(Object(A.a)(l.pathname, "/react-accordion-comp")) ||
                            "/404.html" === a ||
                            a.match(/^\/404\/?$/) ||
                            a.match(/^\/offline-plugin-app-shell-fallback\/?$/)
                        ) &&
                        Object(u.navigate)("/react-accordion-comp" + a + l.search + l.hash, {
                            replace: !0,
                        }),
        ...
        bWFh: function (t, e, n) {
            ...
            t.exports = function (t, e, n) {
                ...
                if (
                    ...
                    (w = n.getConstructor(e, t, v, m)), (c.REQUIRED = !0);
                else if (i(t, !0)) {
                    const R = new w(),
                        O = R[m](g ? {} : -0, 1) != R,
                        E = f(function () {
        ...
        emEt: function (t, e, n) {
            ...
            let p = new Map(),
                ...
                d = function (t) {
                    ...
                    return Object(u.a)(e, "/react-accordion-comp").split("#")[0].split("?")[0];
                };
            function v(t) {
            ...
            var x,
                ...
                O = function (t) {
                    let e;
                    return (
                        "/react-accordion-comp/page-data/" +
                        ("/" === t
                            ? "index"
                ...
                k = (function () {
                    ...
                    return (
                        ...
                        (e.loadAppData = function (t) {
                            ...
                            return (
                                void 0 === t && (t = 0),
                                E("/react-accordion-comp/page-data/app-data.json").then(function (
                                    n,
                                ) {
                                    let r,
                                        o = n.status,
                ...
                if (
                    (_ &&
                        ...
                        d !== Object.prototype &&
                            ...
                            (f ||
                                i(w) === d ||
                                (a ? a(w, d) : "function" != typeof w[g] && u(w, g, m)),
                            c(w, O, !0, !0),
                            f && (p[O] = m))),
                    "values" == h &&
                        j &&
        ...
        pNMO: function (t, e, n) {
            ...
            (u ||
                ...
                c &&
                    ...
                    a || k(Y, "propertyIsEnumerable", ut, { unsafe: !0 }))),
            ...
            q.prototype[F] || j(q.prototype, F, q.prototype.valueOf), M(q, "Symbol"), (T[N] = !0);
        },
        pVnL: function (t, e) {
            function n() {
                return (
...
//# sourceMappingURL=app-a890422fbcf6e52e1e46.js.map
